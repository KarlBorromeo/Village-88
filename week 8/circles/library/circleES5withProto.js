...
Circles.prototype.generate_params = function(){
...
Circles.prototype.generate_random = function(min,max){
    return Math.floor(Math.random()*(max-min)+min);
}
Circles.prototype.create_element = function(){
...
Circles.prototype.draw_circles = function(parent_id){
